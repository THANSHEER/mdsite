...
${renderFooter(config)}
<a class="powered-by-mdsite" href="https://github.com/THANSHEER/mdsite" title="Built with mdsite">${escapeHtml(t('builtWith', config))} mdsite</a>
...
function noFlashScript(config: MdsiteConfig): string {
  ...
  return `<script>(function(){try{var t=localStorage.getItem('mdsite-theme');if(t==='dark'||t==='light')document.documentElement.dataset.theme=t;}catch(e){}})();</script>`;
}
