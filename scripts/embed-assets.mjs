...
const clientJs = path.join(root, 'dist', 'client', 'mdgarden.client.js');
const mermaidJs = path.join(root, 'dist', 'client', 'mdgarden.mermaid.js');
const bundle = path.join(buildDir, 'mdgarden.bundle.cjs');
...
const assets = {
  'mdgarden.client.js': clientJs,
  'mdgarden.mermaid.js': mermaidJs,
...
const seaConfig = {
  main: bundle,
  output: path.join(buildDir, 'mdgarden.blob'),
